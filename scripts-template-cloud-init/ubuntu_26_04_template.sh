#!/bin/bash
# ==============================================================================
# SCRIPT PARA CRIAÇÃO DE TEMPLATE CLOUD-INIT UBUNTU 26.04 NO PROXMOX VE
# ==============================================================================
#
# Script: ubuntu_26_04_template.sh
#
# Descrição:
#   Este script automatiza a criação de um template de máquina virtual (VM)
#   Ubuntu 26.04 (Resolute Raccoon) utilizando Cloud-Init no Proxmox VE.
#
# Funcionalidades:
#   - Coleta de dados (ID, Nome, Storage, Tamanho do disco).
#   - Download e verificação da imagem Ubuntu 26.04 Cloud-Init.
...
#
# Como usar:
#   1. chmod +x ubuntu_26_04_template.sh
#   2. ./ubuntu_26_04_template.sh
...
#
# Notas Importantes:
#   - A imagem baixada ('resolute-server-cloudimg-amd64.img') será armazenada em
...
echo -e "${GREEN}=== Proxmox Cloud-Init Template Creator (Ubuntu 26.04) ===${NC}"
...
read -p "Digite o Nome para o Template (ex: ubuntu-26-04-template): " VM_NAME
...
# Nome da imagem para a versão 26.04 (Resolute)
IMAGE_NAME="resolute-server-cloudimg-amd64.img"

# URL da imagem Cloud-Init do Ubuntu 26.04 (Resolute)
IMAGE_URL="https://cloud-images.ubuntu.com/buildd/daily/resolute/current/$IMAGE_NAME"

echo -e "\n${GREEN}[1/6] Baixando/Verificando imagem Ubuntu 26.04...${NC}"
mkdir -p $IMAGE_DIR
