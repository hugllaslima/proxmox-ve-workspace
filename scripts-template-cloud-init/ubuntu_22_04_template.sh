#!/bin/bash
# ==============================================================================
# SCRIPT PARA CRIAÇÃO DE TEMPLATE CLOUD-INIT UBUNTU 22.04 NO PROXMOX VE
# ==============================================================================
#
# Script: ubuntu_22_04_template.sh
#
# Descrição:
#   Este script automatiza a criação de um template de máquina virtual (VM)
#   Ubuntu 22.04 utilizando Cloud-Init no Proxmox VE.
#
# Funcionalidades:
#   - Coleta de dados (ID, Nome, Storage, Tamanho do disco).
#   - Download e verificação da imagem Ubuntu 22.04 Cloud-Init.
...
#
# Como usar:
#   1. chmod +x ubuntu_22_04_template.sh
...
#
# Notas Importantes:
#   - A imagem baixada ('jammy-server-cloudimg-amd64.img') será armazenada em
...
read -p "Digite o Nome para o Template (ex: ubuntu-22-04-template): " VM_NAME
...
echo -e "\n${GREEN}[1/6] Baixando/Verificando imagem Ubuntu 22.04...${NC}"
mkdir -p $IMAGE_DIR
