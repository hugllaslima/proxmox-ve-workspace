#!/bin/bash
# ==============================================================================
# SCRIPT PARA CRIAÇÃO DE TEMPLATE CLOUD-INIT ORACLE LINUX 9 NO PROXMOX VE
# ==============================================================================
#
# Script: oracle_linux_9_template.sh
#
# Descrição:
#   Este script automatiza a criação de um template de máquina virtual (VM)
#   Oracle Linux 9 utilizando Cloud-Init no Proxmox VE.
#
# Funcionalidades:
#   - Coleta de dados (ID, Nome, Storage, Tamanho do disco).
#   - Download e verificação da imagem Oracle Linux 9 Cloud-Init.
...
#
# Como usar:
#   1. chmod +x oracle_linux_9_template.sh
#   2. ./oracle_linux_9_template.sh
...
#
# Notas Importantes:
#   - A imagem baixada ('OL9U4_x86_64-kvm-b183.qcow2') será armazenada em
...
echo -e "${GREEN}=== Proxmox Cloud-Init Template Creator (Oracle Linux 9) ===${NC}"

# 1. Pergunta o ID da VM
while true; do
    read -p "Digite o ID para a nova VM Template (ex: 9007): " VM_ID
...
read -p "Digite o Nome para o Template (ex: oracle-linux-9-template): " VM_NAME
...
# Nota: Este é um nome de arquivo típico para as imagens KVM da Oracle
IMAGE_NAME="OL9U4_x86_64-kvm-b183.qcow2"

# URL da imagem Cloud-Init do Oracle Linux 9 (Update 4)
IMAGE_URL="https://yum.oracle.com/templates/OracleLinux/OL9/u4/x86_64/$IMAGE_NAME"

echo -e "\n${GREEN}[1/6] Baixando/Verificando imagem Oracle Linux 9...${NC}"
mkdir -p $IMAGE_DIR
