#!/bin/bash
# ==============================================================================
# SCRIPT PARA CRIAÇÃO DE TEMPLATE CLOUD-INIT DEBIAN 13 NO PROXMOX VE
# ==============================================================================
#
# Script: debian_13_template.sh
#
# Descrição:
#   Este script automatiza a criação de um template de máquina virtual (VM)
#   Debian 13 utilizando Cloud-Init no Proxmox VE.
#
# Funcionalidades:
#   - Coleta de dados (ID, Nome, Storage, Tamanho do disco).
#   - Download e verificação da imagem Debian 13 Cloud-Init.
...
#
# Como usar:
#   1. chmod +x debian_13_template.sh
...
#
# Notas Importantes:
#   - A imagem baixada ('debian-13-generic-amd64.qcow2') será armazenada em
...
# URL da imagem Cloud-Init do Debian 13 (Trixie).
# Usando a build diária enquanto o Debian 13 estiver em testing, ou a URL oficial quando lançado.
IMAGE_URL="https://cloud.debian.org/images/cloud/trixie/daily/latest/debian-13-generic-amd64-daily.qcow2"

echo -e "\n${GREEN}[1/6] Baixando/Verificando imagem Debian 13...${NC}"
mkdir -p $IMAGE_DIR
