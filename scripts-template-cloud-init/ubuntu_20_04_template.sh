#!/bin/bash
# ==============================================================================
# SCRIPT PARA CRIAÇÃO DE TEMPLATE CLOUD-INIT UBUNTU 20.04 NO PROXMOX VE
# ==============================================================================
#
# Script: ubuntu_20_04_template.sh
#
# Descrição:
#   Este script automatiza a criação de um template de máquina virtual (VM)
#   Ubuntu 20.04 (Focal Fossa) utilizando Cloud-Init no Proxmox VE.
#
# Funcionalidades:
#   - Coleta de dados (ID, Nome, Storage, Tamanho do disco).
#   - Download e verificação da imagem Ubuntu 20.04 Cloud-Init.
...
#
# Como usar:
#   1. chmod +x ubuntu_20_04_template.sh
#   2. ./ubuntu_20_04_template.sh
...
#
# Notas Importantes:
#   - A imagem baixada ('focal-server-cloudimg-amd64.img') será armazenada em
...
echo -e "${GREEN}=== Proxmox Cloud-Init Template Creator (Ubuntu 20.04) ===${NC}"
...
read -p "Digite o Nome para o Template (ex: ubuntu-20-04-template): " VM_NAME
...
# Nome da imagem para a versão 20.04 (Focal)
IMAGE_NAME="focal-server-cloudimg-amd64.img"

# URL da imagem Cloud-Init do Ubuntu 20.04 (Focal)
IMAGE_URL="https://cloud-images.ubuntu.com/focal/current/$IMAGE_NAME"

echo -e "\n${GREEN}[1/6] Baixando/Verificando imagem Ubuntu 20.04...${NC}"
mkdir -p $IMAGE_DIR
